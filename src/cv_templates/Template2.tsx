...
import { faBriefcase, faContactBook, faEnvelope, faGraduationCap, faLanguage, faMailBulk, faPeopleGroup, faUserCircle, faUserTie } from "@fortawesome/free-solid-svg-icons";
  ...
  return (
    <div className="shadow-lg p-4 font-serif h-[100%]">
      <div className="grid grid-cols-3">
        ...
        <div className="bg-slate-100 col-span-2 p-8 rounded-e-md mb-2">
