    ...
    <>
      <section className="relative h-screen w-screen">
        ...
        <div className=" z-20 flex items-center gap-3 lg:flex-row max-lg:flex-col justify-center h-full  backdrop-blur-sm p-4">
          ...
          <div className="md:w-1/2 max-lg:w-full text-center lg:text-left mr-3 relative">
            ...
            <div className="w-full h-full rounded-full bg-gradient-to-r from-blue-700/65 to-blue-900/85 blur-3xl opacity-50  top-6 z-[-10] absolute"></div>
          </div>
            ...
            <motion.div
              ...
              {templateRoutes.map((temp, index) => (
                <motion.img
                  ...
                  className="max-w-[14vw]  drop-shadow-2xl rounded-md max-lg:top-0  absolute"
      ...
      <section className="p-6">
        <motion.div
          ...
          transition={{ duration: 0.8 }}
          className="flex max-sm:flex-col justify-center items-center gap-5 text-blue-950 font-serif">
